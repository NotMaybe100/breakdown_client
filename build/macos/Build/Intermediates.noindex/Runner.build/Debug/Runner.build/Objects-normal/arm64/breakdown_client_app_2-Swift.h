...
#ifndef BREAKDOWN_CLIENT_APP_2_SWIFT_H
#define BREAKDOWN_CLIENT_APP_2_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="breakdown_client_app_2",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC22breakdown_client_app_211AppDelegate")
...
SWIFT_CLASS("_TtC22breakdown_client_app_217MainFlutterWindow")
